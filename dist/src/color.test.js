...
describe('colorApproximatelyEqual', () => {
    it('compares by hex value', () => {
        ...
        expect(colorApproximatelyEqual({ r: 0, g: 0, b: 0, a: 0.5 }, { r: 0, g: 0, b: 0, a: 0.5 })).toBe(true);
...
describe('rgbToHex', () => {
    it('should convert rgb to hex', () => {
        ...
        expect(rgbToHex({ r: 0.3686274509803922, g: 0.8784313725490196, b: 0.8627450980392157 })).toBe('#5ee0dc');
    });
    it('should convert rgba to hex', () => {
        ...
        expect(rgbToHex({ r: 0.3686274509803922, g: 0.8784313725490196, b: 0.8627450980392157, a: 0 })).toBe('#5ee0dc00');
    });
});
