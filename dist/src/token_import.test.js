...
describe('readJsonFiles', () => {
    ...
    it('handles file names that do not match the expected format', () => {
        ...
        }).toThrowError('Invalid tokens file name: foo.json. File names must be in the format: {collectionName}.{modeName}.json');
    });
...
describe('generatePostVariablesPayload', () => {
    it('does an initial sync', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('does an in-place update', () => __awaiter(void 0, void 0, void 0, function* () {
        const localVariablesResponse = {
            status: 200,
            error: false,
            meta: {
    ...
    it('ignores remote collections and variables', () => {
        ...
        const result = generatePostVariablesPayload(tokensByFile, localVariablesResponse);
        expect(result).toEqual(generatePostVariablesPayload(tokensByFile, {
            status: 200,
            error: false,
            meta: {
                variableCollections: {},
    ...
    it('throws on unsupported token types', () => __awaiter(void 0, void 0, void 0, function* () {
        const localVariablesResponse = {
            status: 200,
            error: false,
            meta: {
...
//# sourceMappingURL=token_import.test.js.map